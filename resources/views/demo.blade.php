        ...
        <div class="content-wrapper-inner">
                ...
                <div class="row">
                  <div class="col-lg-12 main-bar-content">
                    ...
                    <a href="index.html" title="Walton" class="site-logo">
                      <div class="logo-img">
                        <img src="images/logo.png" alt="Walton">
                      </div>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="page-about.html">about the company</a>
                            </li>
                            <li>
                            ...
                            <li>
                              ...
                              <ul>
                                ...
                                <li>
                                  <a href="page-services-single.html">single service</a>
                                </li>
                              </ul>
                            </li>
                            <li>
                              ...
                              <ul>
                                ...
                                <li>
                                  <a href="page-sidebar-left.html">left sidebar page</a>
                                </li>
                                <li>
                                  <a href="page-sidebar-right.html">right sidebar page</a>
                                </li>
                              </ul>
                            </li>
                          </ul>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="page-services.html">Full list of services</a>
                            </li>
                            <li>
                              <a href="page-services-single.html">single service</a>
                            </li>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="portfolio-project.html">portfolio project</a>
                            </li>
                          </ul>
                        </li>
                        <li>
                          <a href="blog-1.html">blog news</a>
                          <ul>
                            <li>
          ...
          <div class="homepage-slider">
            ...
            <div id="homepage-slider" class="owl-theme owl-carousel">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="homepage-slider-item-content">
                        ...
                        <div class="text-2">consulting services</div>
              ...
              <!-- Homepage slider item start -->
              <div class="homepage-slider-item">
                <img src="images/big-images/2.jpg" alt="" class="homepage-slider-item-image">
                <div class="container">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="homepage-slider-item-content">
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <p>Integer a diam sem. Vivamus vehicula consequat leo, ut cursus tellus iaculis et. Etiam volutpat bibendum dui at ullamcorper. Etiam dignissim cursus sem quis pharetra. Morbi suscipit placerat odio, id congue arcu consequat quis. Curabitur
                    congue nibh tempus consectetur blandit. Praesent ipsum lectus, tempus sed tellus et, finibus volutpat orci. Vivamus lobortis consectetur sem nec sollicitudin. </p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="col-lg-12">
                  <div id="index-1-services" class="owl-theme owl-carousel">
                    <div class="icon-box v2">
                      <div class="hover">
                        <img src="images/big-images/4.jpg" alt="">
                        <a href="#">
                    ...
                    <div class="icon-box v2">
                      <div class="hover">
                        <img src="images/big-images/5.jpg" alt="">
                        <a href="#">
                          <span class="wicon-iconmonstr-zoom-in-thin"></span>
                        </a>
                      </div>
                    ...
                    <div class="icon-box v2">
                      <div class="hover">
                        <img src="images/big-images/6.jpg" alt="">
                        <a href="#">
                          <span class="wicon-iconmonstr-zoom-in-thin"></span>
                        </a>
                      </div>
                    ...
                    <div class="icon-box v2">
                      <div class="hover">
                        <img src="images/big-images/7.jpg" alt="">
                        <a href="#">
                          <span class="wicon-iconmonstr-zoom-in-thin"></span>
                        </a>
                      </div>
                    ...
                    <div class="icon-box v2">
                      <div class="hover">
                        <img src="images/big-images/8.jpg" alt="">
                        <a href="#">
                          <span class="wicon-iconmonstr-zoom-in-thin"></span>
                        </a>
                      </div>
                    ...
                    <div class="icon-box v2">
                      <div class="hover">
                        <img src="images/big-images/9.jpg" alt="">
                        <a href="#">
                          <span class="wicon-iconmonstr-zoom-in-thin"></span>
                        </a>
                      </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <p class="text-2">a leading provider of consulting services</p>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="post big-preview">
                    ...
                    <h3 class="post-title">
                      <a href="#">How Walton Consulting is going to change your business strategy</a>
                    </h3>
                    <p class="read-link">
                      <a href="#">Read more
                        <i class="fa"></i>
                ...
                <div class="col-md-6">
                  ...
                  <div class="post preview">
                    <figure class="post-thumbnail">
                      ...
                      <img src="images/big-images/3.jpg" alt="">
                    </figure>
                    <div class="post-content">
                      <ul class="meta">
                        <li class="meta-date">Posted on
                      ...
                      <h4 class="post-title">
                        <a href="#">Why is Walton Consulting the most trending thing right now?</a>
                      </h4>
                    </div>
                  </div>
                  <div class="post preview">
                    ...
                    <div class="post-content">
                      ...
                      <h4 class="post-title">
                        <a href="#">This is how Walton Consulting will look like in 10 years time</a>
                      </h4>
                    </div>
                  </div>
                  <p>
                ...
                <div class="col-md-6 col-lg-7">
                  ...
                  <div data-rt-accordion data-rt-accordion-toggle="on" data-rt-accordion-active="2" class="rt-accordion">
                    <div data-rt-accordion-item class="rt-accordion-item">
                      ...
                      <div class="content">
                        <p>Etiam vel leo lacus. Fusce vestibulum viverra justo, vel dictum lorem venenatis at. Sed eleifend, quam sed commodo varius, mauris magna tristique justo, et volutpat leo urna eget justo. Mauris iaculis dolor quis porta finibus.
                          </p>
            ...
            <div class="row site-footer-content">
              <div class="col-lg-4 col-md-4 site-footer-logo">
                <div>
                  ...
                  <!-- Logo end -->
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur id nunc auctor nisi efficitur mollis. In vel eleifend ex, vitae vestibulum eros. Vestibulum non nibh non dui tempus vehicula at ut felis. Donec sit amet euismod massa.
                    </p>
                </div>
                <p>Copyright @ 2018 U.S.
                  <a href="">Walton Consulting Services</a>, Inc.</p>
              </div>
